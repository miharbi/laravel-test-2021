                            ...
                            <form method="POST" action="{{ route('shippings.store') }}">
                                ...
                                <div class="grid grid-cols-1 gap-0">
                                    <div class="m-2">
                                        ...
                                        <input placeholder="Nombre descriptivo del paquete a enviar..." type="text" id="name" name="name" class="rounded-md w-full" value="{{ old('name') }}" />
                                        @error("name") <span class="text-red-500 text-sm">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="m-2">
                                        <label for="height" class="text-gray-500">Alto(cm)</label>
                                        <input placeholder="Altura del paquete a enviar..." type="text" id="height" name="height" class="rounded-md w-full" value="{{ old('height') }}" />
                                        @error("height") <span class="text-red-500 text-sm">{{ $message }}</span>@enderror
                                    </div>

                                    <div class="m-2">
                                        <label for="width" class="text-gray-500">Ancho(cm)</label>
                                        <input placeholder="Ancho del paquete a enviar..." type="text" id="width" name="width" class="rounded-md w-full" value="{{ old('width') }}" />
                                        @error("width") <span class="text-red-500 text-sm">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="m-2">
                                        <label for="weight" class="text-gray-500">Peso(kg)</label>
                                        <input placeholder="Peso del paquete a enviar..." type="text" id="weight" name="weight" class="rounded-md w-full" value="{{ old('weight') }}" />
                                        @error("weight") <span class="text-red-500 text-sm">{{ $message }}</span>@enderror
                                    </div>
                                    <div class="m-2">
                                        <label for="width" class="text-gray-500">Destino</label>
                                        <select placeholder="Destino del paquete a enviar..." type="text" id="destination" name="destination" class="rounded-md w-full" />
                                        <option value="1" {{ (old('destination') == 1 ? "selected":"") }}>Sucursal EEUU</option>
                                        <option value="2" {{ (old('destination') == 2 ? "selected":"") }}>Sucursal X región Chile</option>
                                        <select />
